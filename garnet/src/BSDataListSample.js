...
var
	...
	DataList = require('garnet/DataList/BSDataList'),
...
var DataListSample = module.exports = kind({
	...
	components: [
		{content: '< BS Data List Sample', classes: 'g-sample-header', ontap: 'goBack'},
...
var data = [
	...
	{subject: 'long subject marqueed', time: '11:50 AM'},
