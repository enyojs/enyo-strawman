...
var
	...
	PopupPanelScroller = require('garnet/PopupPanelScroller/BSPopupPanelScroller'),
...
module.exports = kind({
	...
	kind: Control,
	classes: 'enyo-unselectable enyo-fit enyo-fit garnet g-sample g-sample-confirm-panel',
	handlers: {
		onResult: "result",
		onPopPanel: "result"
	},
	components: [
		{content: '< BS Confirm Panel Sample', classes: 'g-sample-header', ontap: 'goBack'},
