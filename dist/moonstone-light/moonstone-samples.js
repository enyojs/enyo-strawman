	...
	components: [
		{
			...
			kind: VideoPlayer,
			sources: sources,
			poster: '../moonstone/assets/video-poster.png',
			inline: true,
			classes: 'moon-8h',
			autoplay: true,
			infoComponents: [
...
var UserItem = kind({
	...
	components: [
		{name: 'client'},
		{kind: Icon, src: '../moonstone/assets/icon-list.png'}
	]
});
...
module.exports = kind({
	...
	components: [
		...
		{name: 'container', kind: Scroller, fit: true, components: [
			...
			{name: 'listIcon', kind: Icon, src: '../moonstone/assets/icon-list.png', ontap: 'buttonTapped'},
			{classes: 'moon-1v'},
			{kind: Control, tag: 'br'},
			...
			{name: 'listIconButton', kind: IconButton, src: '../moonstone/assets/icon-list.png', small: false, ontap: 'buttonTapped'}
		]},
		...
		{kind: Scroller, fit: true, components: [
			{classes: 'moon-hspacing', controlClasses: 'moon-5h', components: [
				{components: [
					...
					{kind: CheckboxItem, content: 'This is a verrry long option 5 with a custom checkmark', icon: '', src: '../moonstone/assets/icon-button-enyo-logo.png', onchange: 'itemChanged'},
	...
	components: [
		{kind: Scroller, fit: true, components: [
			{fit:true, components: [
				...
				{kind: IconButton, src: '../moonstone/assets/icon-list.png', small: false, ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/icon-album.png', small: false, ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/icon-list.png', ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/icon-album.png', ontap: 'buttonTapped'},
				{classes: 'moon-1v'},
				{kind: Divider, content: 'Image Asset Icons (Vector Image) Buttons:'},
				{kind: IconButton, src: '../moonstone/assets/magnify.svg', small: false, ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/trash.svg', small: false, ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/magnify.svg', ontap: 'buttonTapped'},
				{kind: IconButton, src: '../moonstone/assets/trash.svg', ontap: 'buttonTapped'},
				{classes: 'moon-1v'},
				...
				{kind: IconButton, src: '../moonstone/assets/icon-list.png', small: false, ontap: 'buttonTapped', disabled: true},
				{kind: IconButton, src: '../moonstone/assets/icon-album.png', ontap: 'buttonTapped', disabled: true},
				{classes: 'moon-1v'},
				...
				{classes: 'image-background', components: [
					...
					{kind: IconButton, src: '../moonstone/assets/icon-list.png', small: false, backgroundOpacity: 'translucent', ontap: 'buttonTapped'},
					{kind: IconButton, src: '../moonstone/assets/icon-album.png', backgroundOpacity: 'transparent', ontap: 'buttonTapped'}
				]}
			]}
		]},
		{kind: Divider, content: 'Result'},
...
module.exports = kind({
	...
	components: [
		{kind: Scroller, fit:true, components: [
			...
			{kind: Icon, src: '../moonstone/assets/icon-list.png', ontap: 'buttonTapped'},
			{kind: Icon, src: '../moonstone/assets/icon-album.png', ontap: 'buttonTapped'},
			{classes: 'moon-1v'},
			{kind: Divider, content: 'Image Asset Icons (Vector Image) Buttons:'},
			{kind: Icon, src: '../moonstone/assets/magnify.svg', small: false, ontap: 'buttonTapped'},
			{kind: Icon, src: '../moonstone/assets/trash.svg', small: false, ontap: 'buttonTapped'},
			{kind: Icon, src: '../moonstone/assets/magnify.svg', ontap: 'buttonTapped'},
			{kind: Icon, src: '../moonstone/assets/trash.svg', ontap: 'buttonTapped'},
			{classes: 'moon-1v'},
			...
			{kind: Icon, src: '../moonstone/assets/icon-list.png', ontap: 'buttonTapped', disabled: true},
			{kind: Icon, src: '../moonstone/assets/icon-album.png', ontap: 'buttonTapped', disabled: true},
			{classes: 'moon-1v'},
		...
		{kind: Scroller, classes: 'enyo-fill moon-7h', components: [
			...
			{components: [
				{kind: Item, mixins: [ItemOverlaySupport], autoHideBeginning: true, beginningComponents: [
						{kind: Icon, src: '../moonstone/assets/icon-list.png', small: true}
					], components: [
				...
				{kind: Item, mixins: [ItemOverlaySupport], autoHideEnding: true, endingComponents: [
						{kind: Icon, src: '../moonstone/assets/icon-album.png', small: true}
					], components: [
						{kind: MarqueeText, content: 'These text are flow when item is getting focused'}
					]
				}
		...
		{kind: Scroller, fit: true, components: [
			{kind: Repeater, count:20, onSetupItem: 'setupItem', components: [
				{kind: ObjectActionDecorator, orientation: 'horizontal', components: [
					{kind: ImageItem, source: '../moonstone/assets/default-music.png'}
				], actionComponents: [
...
module.exports = kind({
	...
	data: [
		{src: 'http://enyojs.com/_media/thunder.mp3', trackName: 'Thunder', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/storm-100.png', duration: '0:22'},
		{src: 'http://enyojs.com/_media/engine.mp3', trackName: 'Engine', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/engine-100.png', duration: '0:04'}
	],
	components: [
...
}],'src/AudioPlaybackPlaylistSupportSample':[function (module,exports,global,require,request){
require('moonstone');
...
module.exports = kind({
	...
	classes: 'enyo-unselectable moon sample-audio-playback enyo-fit',
	data: [
		{src: 'http://enyojs.com/_media/thunder1.mp3', trackName: 'Thunder 1', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/storm-100.png', duration: '0:22'},
		{src: 'http://enyojs.com/_media/engine1.mp3', trackName: 'Engine 1', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/engine-100.png', duration: '0:04'},
		{src: 'http://enyojs.com/_media/thunder2.mp3', trackName: 'Thunder 2', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/storm-100.png', duration: '0:22'},
		{src: 'http://enyojs.com/_media/engine2.mp3', trackName: 'Engine 2', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/engine-100.png', duration: '0:04'},
		{src: 'http://enyojs.com/_media/thunder3.mp3', trackName: 'Thunder 3', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/storm-100.png', duration: '0:22'},
		{src: 'http://enyojs.com/_media/engine3.mp3', trackName: 'Engine 3', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/engine-100.png', duration: '0:04'},
		{src: 'http://enyojs.com/_media/thunder4.mp3', trackName: 'Thunder 4', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/storm-100.png', duration: '0:22'},
		{src: 'http://enyojs.com/_media/engine4.mp3', trackName: 'Engine 4', artistName: 'Sound Effects Artist', albumName: 'Sound Effects', albumArt: '../moonstone/assets/engine-100.png', duration: '0:04'}
	],
	handlers: {
...
},{'../../../strawman/AppRouter':'../strawman/AppRouter','../../../strawman/LinkSupport':'../strawman/LinkSupport'}],'src/ActivityPanelsSample':[function (module,exports,global,require,request){
var
	kind = require('enyo/kind');
...
module.exports = kind({
	...
	classes: 'moon enyo-fit enyo-unselectable',
	components: [
		{name: 'player', kind: VideoPlayer, sources: sources, poster: '../moonstone/assets/video-poster.png', autoplay: true, showing: false, infoComponents: [
			{kind: VideoInfoBackground, orient: 'left', background: true, fit: true, components: [
				{
					kind: ChannelInfo,
					channelNo: '13',
...
module.exports = kind({
    ...
    classes: 'moon enyo-fit enyo-unselectable',
    components: [
        {name: 'player', kind: VideoPlayer, sources: sources, poster: '../moonstone/assets/video-poster.png', autoplay: true, infoComponents: [
			{kind: VideoInfoBackground, orient: 'left', background: true, fit: true, components: [
				{
					kind: ChannelInfo,
					channelNo: '13',
	...
	components: [
		{kind: Panel, headerType: 'medium', title: 'List Actions Sample', headerComponents: [
			...
			{kind: TooltipDecorator, components: [
				...
				{kind: ListActions, autoCollapse: true, iconSrc: '../moonstone/assets/icon-list.png', listActions: [
						...
						{title: 'First Panel', components: [
							{kind: Scroller, horizontal: 'hidden', classes: 'enyo-fill', components: [
								{kind: ExpandablePicker, onChange: 'pickerChangedImg', content: 'Select Image', components: [
									{content: 'Music',value: '../moonstone/assets/drawer_icon.png'},
									{content: 'LG', value: '../moonstone/assets/lg.png'},
									{content: 'HTML5', value: '../moonstone/assets/html5.png'},
									{content: 'CSS3', value: '../moonstone/assets/css3.png'},
...
module.exports = kind({
	...
	components: [
		...
		{kind: FittableRows, classes: 'enyo-fit',  components: [
			...
			{components:[
				{kind: TooltipDecorator, components: [
					{kind: IconButton, src: '../moonstone/assets/icon-button-enyo-logo.png'},
