						...
						{title: 'First Panel', components: [
							{kind: Scroller, horizontal: 'hidden', classes: 'enyo-fill', components: [
								{kind: ExpandablePicker, onChange: 'pickerChangedImg', content: 'Select Image', components: [
									{content: 'Music',value: '@../../moonstone-samples/assets/drawer_icon.png'},
									{content: 'LG', value: '@../../moonstone-samples/assets/lg.png'},
									{content: 'HTML5', value: '@../../moonstone-samples/assets/html5.png'},
									{content: 'CSS3', value: '@../../moonstone-samples/assets/css3.png'},
