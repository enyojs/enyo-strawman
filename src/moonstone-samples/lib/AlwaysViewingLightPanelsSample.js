...
module.exports = kind({
	name: 'moon.sample.AlwaysViewingLightPanelsSample',
	classes: 'moon enyo-fit enyo-unselectable',
	style: 'background: gray url(\'http://lorempixel.com/1920/1080/\')',
	components: [
		{name: 'panels', kind: Panels, pattern: 'alwaysviewing', mixins: [Breadcrumb.Support], popOnBack: false, popOnForward: false, classes: 'enyo-fit', useHandle: false, components: [
