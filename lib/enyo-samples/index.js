...
//		PageVisibilitySample: require('./PageVisibilitySample'), //todo: core code needs to be converted to module formate
		...
		SpriteAnimationSample: require('./lib/SpriteAnimationSample'), //left sprite not animating, right sprite is fine.
		StylesheetSupportSample: require('./lib/StylesheetSupportSample'), //inline style not updating after inital render
