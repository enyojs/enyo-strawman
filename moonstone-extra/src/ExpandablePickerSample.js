...
module.exports = kind({
	...
	components: [
		{kind: Panels, pattern: 'activity', classes: 'enyo-fit', components: [
			{name: 'nonGroupedPanel', onChange: 'pickerChanged', title: 'Expandable Pickers', headerType: 'medium', titleBelow: 'Not grouped',
				headerComponents: [
					{kind: Button, content:'Grouped Pickers', name:'groupedToggle', ontap: 'groupedToggleTapped'}
				],
				components: [
			...
			{name: 'groupedPanel', onChange: 'pickerChanged', title: 'Expandable Pickers', headerType: 'medium', titleBelow: 'Grouped', components: [
	...
	groupedToggleTapped: function(inSender, inEvent) {
